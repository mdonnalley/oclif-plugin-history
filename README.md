...
<!-- usage -->
```sh-session
$ npm install -g @oclif/plugin-history
$ oex COMMAND
running command...
$ oex (--version)
@oclif/plugin-history/0.0.0 darwin-arm64 node-v20.11.0
$ oex --help [COMMAND]
USAGE
  $ oex COMMAND
...
...
_See code: [src/commands/hello/index.ts](https://github.com/oclif/plugin-history/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/oclif/plugin-history/blob/v0.0.0/src/commands/hello/world.ts)_
...
DESCRIPTION
  ...
  Uses bundled npm executable to install plugins into /Users/mdonnalley/.local/share/oex
